...
일반 모드(표준 UI) 지원<br>
기존 키오스크 사용자에게 친숙한 터치 인터페이스 제공<br>
알레르기/비건/영양 정보 아이콘(뱃지) 표시로 정보 접근성 강화<br>
...
선제적 맞춤형 접근성 제공<br>
연령대 추정 기반으로 '어르신 모드'를 먼저 제안하여 사용 장벽 최소화<br
음성 중심의 직관적 경험 구현<br>
메뉴 검색부터 결제까지 자연어 음성 명령으로 처리<br>
확장성과 비용 효율성 확보<br>
웹 기반 Streamlit 구현으로 하드웨어 종속성 제거<br>
JSON 교체만으로 다양한 매장에 확장 적용 가능<br>
사용자 오류 및 운영 부담 최소화<br>
주문 실수·대기열 지연 해소<br>
매장 운영 효율 및 고객 만족도 동시 향상<br>

</details>
<details> <summary>기대효과</summary>
사용자 측면: 디지털 접근성 향상<br>
고령층과 디지털 취약계층의 심리적 장벽 해소<br>
음성 기반 경험을 통한 디지털 자신감 증대<br>
비즈니스 측면: 운영 효율 및 고객 만족도 제고<br>
주문 오류·대기 시간 단축<br>
직원의 응대 부담 감소<br>
전 고객 만족도 향상<br>
기술 측면: 높은 확장성과 적용성<br>
웹 기반 구현으로 전용 장비 불필요<br>
다양한 매장에 저비용·신속 확장 가능<br>
사회적 측면: 디지털 포용 사회 기여<br>
취약계층의 정보 격차 해소<br>
