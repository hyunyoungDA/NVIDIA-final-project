...
# <div> 🎙️ 키오스크 음성 보조 챗봇, 키오스픽 </div>
<div> 
  <p>NVIDIA-final-project Team 4</p>
  <br>
  <h3>🎯 주제</h3>
  <p>키오스크 음성 보조 챗봇, 키오스픽</p>
  <br>
  <h3>🎉 서비스 내용</h3>
  <p> 고령층을 포함한 디지털 취약계층을 대상으로 하는 키오스크 음성 보조 챗봇 서비스를 제공하고 있습니다!<br>
  음성 안내, 음성 명령, 알레르기 및 특정 식단 필터링, 주문 내용 확인 등 실질적인 기능을 구현하고 있습니다!</p>
  <br>
  <h3>🗓️ 프로젝트 수행 기간</h3>
...
<table style="width:100%; text-align:center; table-layout:fixed; border-collapse:collapse;">
  ...
  <tbody>
    <tr>
      ...
      <td><img src="[https://cdn.ppomppu.co.kr/zboard/data3/2022/0509/20220509173224_d9N4ZGtBVR.jpeg](https://github.com/user-attachments/assets/50150d92-b61b-4f5c-bf4c-add6a15a59be)" style="width:150px; height:auto;" alt="김민지"></td>
      ...
      <td><img src="https://cdn.ppomppu.co.kr/zboard/data3/2022/0509/20220509173224_d9N4ZGtBVR.jpeg" style="width:150px; height:auto;" alt="전지성"></td>
    </tr>
    <tr>
...
<details>
  ...
  디지털 전환이 가속화됨에 따라 키오스크는 일상적인 서비스로 자리 잡았으나, 작은 글씨, 복잡한 사용자 인터페이스, 영양 정보 확인의 어려움 등으로 인해 고령층을 포함한 디지털 취약계층은 여전히 사용에 큰 장벽을 느끼고 있습니다. 기존의 단순 화면 확대 기능만으로는 이러한 문제를 근본적으로 해결하기 어렵습니다. 따라서 본 프로젝트는 음성 안내, 음성 명령, 알레르기 및 특정 식단 필터링, 주문 내용 확인 등 실질적인 기능을 구현하여 현장에서 발생하는 주문 오류를 최소화하고 사용성을 극대화하고자 합니다. <br>
  특히, 사용자의 프라이버시를 최우선으로 고려하여, 개인을 식별하지 않는 경량 컴퓨터 비전 기술로 사용자의 연령대를 추정하고, 이를 바탕으로 접근성 향상 기능을 먼저 제안하는 선제적 지원 방식을 도입하여 차별점을 두었습니다.
</details>
<details>
  <summary>주요 타겟층</summary>

  - 청약 제도에 대한 이해도는 낮으나 주택 마련에 대한 관심과 의지가 높은 2030 사회초년생 <br>
  - 복잡한 청약 제도로 인해 정보 획득에 어려움을 겪는 청년층<br>
  - 체계적인 청약 준비를 원하는 예비 청약자<br>

</details>
<details>
  <summary>핵심 기능</summary>
  
  1. 초보자를 위한 AI 기반 청약 상담 챗봇 : 청약정보 알려주는 기능<br>
  - 맞춤형 청약 정보 안내<br>
  - 청약 기초 지식 제공<br>
  - 청약신청 가상체험<br>
  ...
  2. 청약 의사결정 지원 시스템<br>
  - 개인별 청약 가능 여부 진단<br>
  - 로그인 정보 토대로 대화진행...(예정)<br>

  3. AI 기반 실시간 상담 서비스<br>
  - 맞춤형 청약 전략
...
<details>
  ...
  1. 개인별 상황에 맞는 맞춤형 청약 정보 제공<br>
  2. 실시간 상담을 통한 정보 접근성 향상<br>
  3. 청약 자격 정확성 제공<br>
...
<details>
  ...
  - AI 챗봇을 통한 복잡한 청약 규정과 절차에 대해 쉬운 설명 제공 <br>
  - 맞춤형 정보 제공으로 청약 진입 장벽 완화<br>
  - 실시간 상담을 통한 즉각적인 의문점 해소 <br>
  
  2. 청약 부적격 당첨자 감소<br>
  - 신청자의 입력 실수 최소화 <br>
  - AI 기반 자격 검증을 통한 부적격 요소 사전 점검<br>
  - 개인별 맞춤형 가이드를 통한 정확한 청약 신청 지원<br>
  - 실시간 정책 업데이트를 통한 최신 정보 반영 <br>

  3. 서비스 효율성 및 만족도 증대<br>
  - 24시간 실시간 상담으로 접근성 향상<br>
  - 원스톱 서비스를 통한 사용자 편의성 증대<br>
  - 금융기관 연계를 통한 통합 서비스 제공<br>
